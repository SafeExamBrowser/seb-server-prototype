...
@Lazy
@Component
public class InstitutionModifiedActionHandler implements ActivityActionHandler {

    @Override
    public ActionDefinition handlesAction() {
        return ActionDefinition.INSTITUTION_MODIFY;
    }
    ...
    public void notifyAction(final ActionEvent event, final Tree navigation, final PageContext composerCtx) {
        ...
        final TreeItem selected = ActivitiesPane.findItemByActivity(
                navigation.getItems(),
