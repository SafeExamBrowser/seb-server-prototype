...
@Lazy
@Component
public class GetRunningExamNames extends GetNames {

    protected GetRunningExamNames(final RestCallBuilder restCallBuilder) {
        super(restCallBuilder, "exam/running/names");
    }
