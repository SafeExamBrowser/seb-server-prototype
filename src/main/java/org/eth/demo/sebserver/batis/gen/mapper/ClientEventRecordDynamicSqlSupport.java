...
public final class ClientEventRecordDynamicSqlSupport {
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2018-05-09T14:50:25.072+02:00", comments="Source Table: client_event")
    public static final ClientEventRecord clientEventRecord = new ClientEventRecord();

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2018-05-09T14:50:25.072+02:00", comments="Source field: client_event.id")
    public static final SqlColumn<Long> id = clientEventRecord.id;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2018-05-09T14:50:25.073+02:00", comments="Source field: client_event.exam_id")
    public static final SqlColumn<Long> examId = clientEventRecord.examId;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2018-05-09T14:50:25.073+02:00", comments="Source field: client_event.client_id")
    public static final SqlColumn<Long> clientId = clientEventRecord.clientId;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2018-05-09T14:50:25.073+02:00", comments="Source field: client_event.type")
    public static final SqlColumn<Integer> type = clientEventRecord.type;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2018-05-09T14:50:25.073+02:00", comments="Source field: client_event.timestamp")
    public static final SqlColumn<Long> timestamp = clientEventRecord.timestamp;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2018-05-09T14:50:25.074+02:00", comments="Source field: client_event.numeric_value")
    public static final SqlColumn<BigDecimal> numericValue = clientEventRecord.numericValue;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2018-05-09T14:50:25.074+02:00", comments="Source field: client_event.text")
