...
public interface ConfigurationAttributeRecordMapper {
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2018-07-24T11:31:47.163+02:00", comments="Source Table: configuration_attribute")
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2018-07-24T11:31:47.164+02:00", comments="Source Table: configuration_attribute")
    @SelectProvider(type=SqlProviderAdapter.class, method="select")
    @ConstructorArgs({
        @Arg(column="id", javaType=Long.class, jdbcType=JdbcType.BIGINT, id=true),
        @Arg(column="name", javaType=String.class, jdbcType=JdbcType.VARCHAR),
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2018-07-24T11:31:47.166+02:00", comments="Source Table: configuration_attribute")
    @UpdateProvider(type=SqlProviderAdapter.class, method="update")
    int update(UpdateStatementProvider updateStatement);

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2018-07-24T11:31:47.167+02:00", comments="Source Table: configuration_attribute")
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2018-07-24T11:31:47.168+02:00", comments="Source Table: configuration_attribute")
    ...
    default QueryExpressionDSL<MyBatis3SelectModelAdapter<List<ConfigurationAttributeRecord>>> selectByExample() {
        return SelectDSL.selectWithMapper(this::selectMany, id, name, type, parentId, resources, validator, dependencies)
                .from(configurationAttributeRecord);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2018-07-24T11:31:47.168+02:00", comments="Source Table: configuration_attribute")
    default QueryExpressionDSL<MyBatis3SelectModelAdapter<List<ConfigurationAttributeRecord>>> selectDistinctByExample() {
        return SelectDSL.selectDistinctWithMapper(this::selectMany, id, name, type, parentId, resources, validator, dependencies)
                .from(configurationAttributeRecord);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2018-07-24T11:31:47.168+02:00", comments="Source Table: configuration_attribute")
    default ConfigurationAttributeRecord selectByPrimaryKey(Long id_) {
        return SelectDSL.selectWithMapper(this::selectOne, id, name, type, parentId, resources, validator, dependencies)
                .from(configurationAttributeRecord)
                .where(id, isEqualTo(id_))
                .build()
                .execute();
