...
public interface ExamConfigurationMapRecordMapper {
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2018-08-15T14:53:13.415+02:00", comments="Source Table: exam_configuration_map")
    @SelectProvider(type=SqlProviderAdapter.class, method="select")
    long count(SelectStatementProvider selectStatement);

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2018-08-15T14:53:13.416+02:00", comments="Source Table: exam_configuration_map")
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2018-08-15T14:53:13.417+02:00", comments="Source Table: exam_configuration_map")
    @SelectProvider(type=SqlProviderAdapter.class, method="select")
    @ConstructorArgs({
        @Arg(column="id", javaType=Long.class, jdbcType=JdbcType.BIGINT, id=true),
        @Arg(column="exam_id", javaType=Long.class, jdbcType=JdbcType.BIGINT),
    ...
    default QueryExpressionDSL<MyBatis3SelectModelAdapter<List<ExamConfigurationMapRecord>>> selectByExample() {
        return SelectDSL.selectWithMapper(this::selectMany, id, examId, configurationNodeId, clientInfo)
                .from(examConfigurationMapRecord);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2018-08-15T14:53:13.417+02:00", comments="Source Table: exam_configuration_map")
    default QueryExpressionDSL<MyBatis3SelectModelAdapter<List<ExamConfigurationMapRecord>>> selectDistinctByExample() {
        return SelectDSL.selectDistinctWithMapper(this::selectMany, id, examId, configurationNodeId, clientInfo)
                .from(examConfigurationMapRecord);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2018-08-15T14:53:13.417+02:00", comments="Source Table: exam_configuration_map")
    default ExamConfigurationMapRecord selectByPrimaryKey(Long id_) {
        return SelectDSL.selectWithMapper(this::selectOne, id, examId, configurationNodeId, clientInfo)
                .from(examConfigurationMapRecord)
                .where(id, isEqualTo(id_))
                .build()
                .execute();
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2018-08-15T14:53:13.418+02:00", comments="Source Table: exam_configuration_map")
