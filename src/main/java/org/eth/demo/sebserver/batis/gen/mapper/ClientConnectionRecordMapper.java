...
public interface ClientConnectionRecordMapper {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2018-08-03T08:27:35.499+02:00", comments="Source Table: client_connection")
    @SelectProvider(type=SqlProviderAdapter.class, method="select")
    @ConstructorArgs({
        ...
        @Arg(column="lms_auth_url", javaType=String.class, jdbcType=JdbcType.VARCHAR)
    })
    ...
    default int insert(ClientConnectionRecord record) {
        return insert(SqlBuilder.insert(record)
                ...
                .map(lmsAuthUrl).toProperty("lmsAuthUrl")
                .build()
    ...
    default int insertSelective(ClientConnectionRecord record) {
        return insert(SqlBuilder.insert(record)
                ...
                .map(lmsAuthUrl).toPropertyWhenPresent("lmsAuthUrl", record::getLmsAuthUrl)
                .build()
                .render(RenderingStrategy.MYBATIS3));
    }
    ...
    default QueryExpressionDSL<MyBatis3SelectModelAdapter<List<ClientConnectionRecord>>> selectByExample() {
        return SelectDSL.selectWithMapper(this::selectMany, id, examId, status, token, lmsAuthUrl)
                .from(clientConnectionRecord);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2018-08-03T08:27:35.499+02:00", comments="Source Table: client_connection")
    default QueryExpressionDSL<MyBatis3SelectModelAdapter<List<ClientConnectionRecord>>> selectDistinctByExample() {
        return SelectDSL.selectDistinctWithMapper(this::selectMany, id, examId, status, token, lmsAuthUrl)
                .from(clientConnectionRecord);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2018-08-03T08:27:35.499+02:00", comments="Source Table: client_connection")
    default ClientConnectionRecord selectByPrimaryKey(Long id_) {
        return SelectDSL.selectWithMapper(this::selectOne, id, examId, status, token, lmsAuthUrl)
                .from(clientConnectionRecord)
                .where(id, isEqualTo(id_))
                .build()
                .execute();
    ...
    default UpdateDSL<MyBatis3UpdateModelAdapter<Integer>> updateByExample(ClientConnectionRecord record) {
        return UpdateDSL.updateWithMapper(this::update, clientConnectionRecord)
                ...
                .set(lmsAuthUrl).equalTo(record::getLmsAuthUrl);
    }
    ...
    default UpdateDSL<MyBatis3UpdateModelAdapter<Integer>> updateByExampleSelective(ClientConnectionRecord record) {
        return UpdateDSL.updateWithMapper(this::update, clientConnectionRecord)
                ...
                .set(lmsAuthUrl).equalToWhenPresent(record::getLmsAuthUrl);
    }
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2018-08-03T08:27:35.500+02:00", comments="Source Table: client_connection")
