...
import static org.eth.demo.sebserver.batis.gen.mapper.ClientEventRecordDynamicSqlSupport.*;
...
public interface ClientEventRecordMapper {
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2018-07-25T15:07:26.595+02:00", comments="Source Table: client_event")
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2018-07-25T15:07:26.596+02:00", comments="Source Table: client_event")
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2018-07-25T15:07:26.612+02:00", comments="Source Table: client_event")
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2018-07-25T15:07:26.613+02:00", comments="Source Table: client_event")
    default QueryExpressionDSL<MyBatis3SelectModelAdapter<List<ClientEventRecord>>> selectByExample() {
        return SelectDSL.selectWithMapper(this::selectMany, id, examId, clientId, type, timestamp, numericValue, text)
                .from(clientEventRecord);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2018-07-25T15:07:26.613+02:00", comments="Source Table: client_event")
    default QueryExpressionDSL<MyBatis3SelectModelAdapter<List<ClientEventRecord>>> selectDistinctByExample() {
        return SelectDSL.selectDistinctWithMapper(this::selectMany, id, examId, clientId, type, timestamp, numericValue, text)
                .from(clientEventRecord);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2018-07-25T15:07:26.613+02:00", comments="Source Table: client_event")
    default ClientEventRecord selectByPrimaryKey(Long id_) {
        return SelectDSL.selectWithMapper(this::selectOne, id, examId, clientId, type, timestamp, numericValue, text)
                .from(clientEventRecord)
                .where(id, isEqualTo(id_))
                .build()
                .execute();
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2018-07-25T15:07:26.614+02:00", comments="Source Table: client_event")
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2018-07-25T15:07:26.615+02:00", comments="Source Table: client_event")
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2018-07-25T15:07:26.616+02:00", comments="Source Table: client_event")
