...
public interface ClientEventRecordMapper {
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2018-08-10T15:49:36.993+02:00", comments="Source Table: client_event")
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2018-08-10T15:49:36.994+02:00", comments="Source Table: client_event")
    ...
    default QueryExpressionDSL<MyBatis3SelectModelAdapter<List<ClientEventRecord>>> selectByExample() {
        return SelectDSL.selectWithMapper(this::selectMany, id, examId, clientIdentifier, type, timestamp, numericValue, text)
                .from(clientEventRecord);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2018-08-10T15:49:36.994+02:00", comments="Source Table: client_event")
    default QueryExpressionDSL<MyBatis3SelectModelAdapter<List<ClientEventRecord>>> selectDistinctByExample() {
        return SelectDSL.selectDistinctWithMapper(this::selectMany, id, examId, clientIdentifier, type, timestamp, numericValue, text)
                .from(clientEventRecord);
    }

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2018-08-10T15:49:36.994+02:00", comments="Source Table: client_event")
    default ClientEventRecord selectByPrimaryKey(Long id_) {
        return SelectDSL.selectWithMapper(this::selectOne, id, examId, clientIdentifier, type, timestamp, numericValue, text)
                .from(clientEventRecord)
                .where(id, isEqualTo(id_))
                .build()
                .execute();
